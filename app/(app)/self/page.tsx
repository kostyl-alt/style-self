...
function DiagnosisTab() {
  ...
  return (
    <div className="space-y-5 py-4">
      ...
      {/* Section 3 + 4: なりたい自分 / 避けている印象（横2列、モバイルは縦） */}
      ...
      {/* v1/v2 互換：旧 plainSummary（hasV3 が無い場合のみ表示） */}
      ...
      {/* もっと詳しく：style structure / belief keywords は折りたたみ */}
