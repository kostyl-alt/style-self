    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-lg mx-auto px-4 py-12 space-y-6">
        ...
        {error && (
          <div className="bg-red-50 border border-red-100 rounded-xl px-4 py-3">
            ...
            {error.includes("所有中のアイテムがありません") && (
              <Link
                href="/wardrobe"
                className="inline-block text-xs text-gray-600 underline underline-offset-2 hover:text-gray-900"
              >
                クローゼットにアイテムを追加する →
              </Link>
            )}
        ...
        <button
          ...
          disabled={loading || (words.length === 0 && !theme.trim())}
        ...
        {result && (
          <div className="space-y-4">
            ...
            <CoordinateCard
              ...
              scene={result.abstractWords.join(" / ")}
              onSave={handleSave}
              isSaving={isSaving}
              isSaved={isSaved}
            />
