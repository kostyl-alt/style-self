...
・構図: editorial framing / centered portrait / three-quarter view 等
  ★ ★ ★ ただし下記【厳守 4】が ★ 構図 / 姿勢 / 編集度を ★ 上書きする(★ 厳守 4 が ★ 優先)。

【★ ★ ★ 厳守 4: ★ E-0b-rev Phase 1 購入判断用画像 必須要件】
画像の目的は ★ 広告ビジュアルではなく ★ ★ ★ 「購入判断」です。
コーデの ★ 丈感 / サイズ感 / 体との関係 が ★ 読み取れる ★ 試着室寄りの画像を出力させてください。

★ ★ 6 重視ポイント(★ E-0b-rev §1.3 verbatim):
  1. ★ 正面から全身(顔から靴までフレームに収まる・クロップ禁止)
  2. ★ 体の比率が歪まない(自然なプロポーション)
  3. ★ 服の丈感が分かる(コート / トップス / ボトムスの長さが明確)
  4. ★ 肩幅 / 身幅 / 袖丈 / パンツの太さが分かる
  5. ★ 靴とのバランスが分かる(靴がフレーム内・全身との関係が見える)
  6. ★ ★ 過度に編集的 / 二次元的 / 広告風にしない(★ カタログ完璧さでなく試着室リアル)

★ ★ ★ 必ず prompt に含める英語キーワード(★ 漏れたら出力不合格):
  - "full-body front view"
  - "natural body proportions"
  - "clearly visible garment length"
  - "shoulder width / sleeve length / pant width discernible"
  - "shoes in frame, balanced with overall outfit"
  - "realistic fitting-room aesthetic, not overly stylized or editorial"

★ ★ ★ アスペクト比は ★ 縦長(★ 全身が収まる):
  - "vertical full-body framing, 3:4 aspect ratio preferred"

★ ★ ★ ★ 禁止語(★ 出力に ★ 含めない):
  - "high fashion editorial"
  - "magazine-cover styling"
  - "dramatic dynamic pose"
  - "cropped" / "close-up" / "torso shot" / "headshot"(★ 部分切り取り全般)
  - "exaggerated angle" / "low angle" / "extreme low angle"(★ 極端な角度)

★ ★ ★ 三位一体整合(★ 内部整理):
  - E-0a(厳守 2 / 表面真似禁止): 質感翻訳 ★ 維持
  - E-0c(厳守 1 / 否定形ゼロ): 中立英語 ★ 維持
  - ★ ★ E-0b-rev(本 厳守 4 / 購入判断): 構図 + 試着室リアル ★ 上書き優先
