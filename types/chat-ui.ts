...
export type MessageContent =
  ...
  | { kind: "photos-sent";   photoDataUrls: string[]; storagePaths?: string[]; caption?: string }  // ★ 📷構造の送信バブル: 送った写真を通常サイズで表示。photoDataUrls=ライブ表示の base64・storagePaths=Supabase Storage 永続キー(第2段・base64 を DB/再表示に載せないため。署名URLで解決)。DB保存自体は第3段(現状 ephemeral)
